...
public class AZTitleDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if(mTitleAttributes.isDrawFloat){
            if (parent.getAdapter() == null || !(parent.getAdapter() instanceof AZBaseAdapter)) {
                return;
            }
            AZBaseAdapter adapter = (AZBaseAdapter) parent.getAdapter();
            ...
            mBackgroundPaint.setColor(mTitleAttributes.mFloatBackgroundColor);
            ...
            mTitleTextPaint.setTextSize(mTitleAttributes.mFloatTextSize);
            mTitleTextPaint.setColor(mTitleAttributes.mFloatTextColor);
    ...
    private void drawTitleItem(Canvas c, RecyclerView parent, View child, String letters) {
        ...
        mTitleTextPaint.setTextSize(mTitleAttributes.mTextSize);
        mTitleTextPaint.setColor(mTitleAttributes.mTextColor);
        mTitleTextPaint.setFakeBoldText(false);
    ...
    public static class TitleAttributes {
         ...
         * 悬浮标题背景
         */
        int mFloatBackgroundColor;
        /**
         * 是否绘制悬浮标题背景
         */
        boolean isDrawFloat = true;
        ...
        public TitleAttributes(Context context) {
            ...
            mFloatTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 16, context.getResources().getDisplayMetrics());
            mTextColor = Color.parseColor("#333333");
            mBackgroundColor = Color.parseColor("#00000000");
            mFloatTextColor = Color.parseColor("#ffffff");
            mFloatBackgroundColor = Color.BLUE;
        }
        ...
        public TitleAttributes setDrawFloat(boolean drawFloat) {
            isDrawFloat = drawFloat;
            return this;
        }

        public void setFloatTextColor(int mFloatTextColor) {
            this.mFloatTextColor = mFloatTextColor;
        }

        public void setFloatBackgroundColor(int mFloatBackgroundColor) {
            this.mFloatBackgroundColor = mFloatBackgroundColor;
        }

        public void setFloatTextSize(int mFloatTextSize) {
            this.mFloatTextSize = mFloatTextSize;
        }
    }
}
