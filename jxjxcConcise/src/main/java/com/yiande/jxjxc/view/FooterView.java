...
public class FooterView extends ClassicsAbstract<ClassicsFooter> implements RefreshFooter {
    ...
    public FooterView(Context context, AttributeSet attrs) {
        ...
        titleImg = thisView.findViewById(R.id.srl_classics_titleImg);

        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.FooterView);
