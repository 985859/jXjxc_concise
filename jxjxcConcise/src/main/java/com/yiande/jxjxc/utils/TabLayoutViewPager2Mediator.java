 ...
 * the user drags the ViewPager2. TabLayoutViewPager2Mediator will listen to ViewPager2's OnPageChangeCallback
 * to adjust tab when ViewPager2 moves. TabLayoutViewPager2Mediator listens to TabLayout's
 * OnTabSelectedListener to adjust VP2 when tab moves. TabLayoutViewPager2Mediator listens to RecyclerView's
 ...
 * adapter and then call {@link #attach()} on it. Instantiating a TabLayoutViewPager2Mediator will only create
...
public final class TabLayoutViewPager2Mediator {
    ...
    public TabLayoutViewPager2Mediator(
     ...
     * set. To be called on a new instance of TabLayoutViewPager2Mediator or if the ViewPager2's adapter
     * changes.
     *
    ...
    public void attach() {
        if (attached) {
            throw new IllegalStateException("TabLayoutViewPager2Mediator is already attached");
        }
        adapter = viewPager.getAdapter();
        if (adapter == null) {
            throw new IllegalStateException(
                    "TabLayoutViewPager2Mediator attached before ViewPager2 has an " + "adapter");
        }
        attached = true;
    ...
    /**
     * Unlink the TabLayout and the ViewPager. To be called on a stale TabLayoutViewPager2Mediator if a new one
